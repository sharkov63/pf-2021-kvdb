...
internal class MergeOverwriteTests {
    ...
    private fun correctMergeOverwriteTestTemplate(testName: String) {
        ...
        mergeDataBases(dbPath1, dbPath2, dbPathOut, true)
    ...
    private fun incorrectMergeOverwriteTestTemplate(testName: String) {
        val noExitSecurityManager = NoExitSecurityManager()
        System.setSecurityManager(noExitSecurityManager)
        assertFails { correctMergeOverwriteTestTemplate(testName) }
    }
    ...
    fun noIntersection() {
        ...
        correctMergeOverwriteTestTemplate(testName)
    }
    ...
    fun firstFileHasNotBeenCreated() {
        ...
        incorrectMergeOverwriteTestTemplate(testName)
    }
    ...
    fun mergeToFirstFile() {
        ...
        writeDatabaseToFile(dbFile1, dataInFirst)
        mergeDataBases(dbPath1, dbPath2, dbPath1, true)
